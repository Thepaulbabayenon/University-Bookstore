              ...
              <div className="p-6">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                      <div>
                          ...
                          <input type="number" id="amount" name="amount" className="form-input mt-1 block w-full" value={formData.amount} onChange={handleInputChange} required />
                      </div>
                      <div>
                          <label htmlFor="cardNumber" className="block font-medium">Card Number</label>
                          <input type="text" id="cardNumber" name="cardNumber" className="form-input mt-1 block w-full" value={formData.cardNumber} onChange={handleInputChange} required />
                      </div>
                      <div className="flex flex-wrap -mx-3 mb-4">
                          <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                              <label htmlFor="expiryDate" className="block font-medium">Expiry Date</label>
                              <input type="text" id="expiryDate" name="expiryDate" placeholder="MM/YY" className="form-input mt-1 block w-full" value={formData.expiryDate} onChange={handleInputChange} required />
                          </div>
                          <div className="w-full md:w-1/2 px-3">
                              <label htmlFor="cvv" className="block font-medium">CVV</label>
                              <input type="text" id="cvv" name="cvv" className="form-input mt-1 block w-full" value={formData.cvv} onChange={handleInputChange} required />
                          </div>
                      </div>
                      <div>
                          <label htmlFor="billingAddress" className="block font-medium">Billing Address</label>
                          <textarea id="billingAddress" name="billingAddress" rows={3} className="form-textarea mt-1 block w-full" value={formData.billingAddress} onChange={handleInputChange} required />
                      </div>
